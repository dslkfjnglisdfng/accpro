...
class paths:
    ...
    raw_dipimu_dir = 'data/dataset_raw/DIP_IMU/DIP_IMU'   # raw DIP-IMU dataset path (raw_dipimu_dir/s_01/*.pkl)
    ...
    smpl_file = 'models/smpltoPython/smpl/models/basicmodel_m_lbs_10_207_0_v1.0.0.pkl'              # official SMPL model path
...
class leg_joints:
    right_leg =[8,5,2]
    right_leg_p = [5,2,0]
    right_leg_knee_id_in_imudata = 3
    left_leg = [7,4,1]
    left_leg_p = [4,1,0]
    left_leg_knee_id_in_imudata = 2
    root_id_in_imudata = 5
class leg_used(Enum):
    RIGHT_LEG = 0
    LEFT_LEG = 1
vel_scale = 3
